...
select concat(last_name, ', ', first_name) full_name from employees limit 10;
# Add the date of birth for each employee as 'DOB' to the query.
select concat(last_name, ', ', first_name) full_name, birth_date as dob from employees limit 10;
...
select concat(emp_no, ' - ', last_name, ', ', first_name) full_name, birth_date as dob from employees limit 10;